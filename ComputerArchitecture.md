...
+   kompyuterni tashqi qurilmalar bilan bog'lab ular o'rtasida ma'lumot almashinishini ta'minlab beradi
...
57. 101011₂ ni o'nlik sanoq tizimidagi sonda ifodalang.
+   43

58. 110111₂ ni o'nlik sanoq tizimidagi sonda ifodalang. 
+   55

59. 2910 sonini ikkilik sanoq tizimida ifodalang. 
+   101101001110

60. 12.25₁₀ sonini ikkilik sanoq tizimida ifodalang.
+   1100.01₂

61. 9.125₁₀ sonini ikkilik sanoq tizimida ifodalang.
+   1001.001

62. 18.625₁₀ sonini ikkilik sanoq tizimida ifodalang. 
+   10010.101

63. 19.375₁₀ sonini ikkilik sanoq tizimida ifodalang.
+   10011.011

64. 7.75₁₀ ni ikkilik sanoq tizimida ifodalang.
+   111.110011
-   111.111
...
#   Execute Instruction (ko'rsatmani bajarish)
-   Process Instruction (ko'rsatmani amalga oshirish)
...
+   Kompyuterga zararli bo'lgan dasturlarni aniqlash va ularni tozlash

83. Quyidagi berilganlardan qaysi biri kompyuterning asosiy vazifasi hisoblanmaydi? 
+   internet orqali ma'lumotlarni qidirish va tizimni ishga tushirish
...
+   xotirani ierarxiyasini ko'proq bo'limlarga bo'lish
...
+   Dasturlasa bo'ladigan doimiz xotira

124. PROM dasturchisining asosiy vazifasi nima? 
-   kompyuter kiritish/chiqarish dasturlarini yaratish
...
+    ma“lumotning kirib kelayotgan va jo“natilishi kerak bo“lgan manzilni uzatish


132. Kompyuter nazorat yo'lagining asosiy vazifasi to'g'ri berilgan qatorni toping. 
+   kompyuter modullari o'rtasida buyruq va nazorat signallarini tashish
...
140. 8 bit kenglikdagi ma'lumotlar yo'lagidan ma'lumot 3 marta xotiraga murojaat qilish orqali jo'natildi. Ma'lumot hajmini toping. 
...
+   kiritish/chiqarish qurilmalarini nazorat qilish
...
157. 41₁₀ o'nlik sanoq sistemasidagi sonni ikkilik sanoq sistemasida tasvirlang. 
+   101001

158. 49₁₀ o'nlik sanoq sistemasidagi sonni ikkilik sanoq sistemasida tasvirlang.
...
161. 61.5₁₀ o'nlik sanoq sistemasidagi sonni ikkilik sanoq sistemasida tasvirlang. 
+   111101.1
...
163. 61.125₁₀ o'nlik sanoq sistemasidagi sonni ikkilik sanoq sistemasida tasvirlang. 
+   111101.001

164. 62.625₁₀ o'nlik sanoq sistemasidagi sonni ikkilik sanoq sistemasida tasvirlang. 
+   111110.101

165. 0.625₁₀ o'nlik sanoq sistemasidagi sonni ikkilik sanoq sistemasida ifodalang.
+   0.101

166. Ikkilik sanoq sistemasidagi 11012 + 101112 sonlarining yig'indisini toping. 
11012 + 101112 = 1000012

167. Ikkilik sanoq sistemasidagi 1101₂ + 101₂ sonlarining yig'inidisini toping. 
+   10010₂
...
171. Ikkilik sanoq sistemasidagi 100₂ – 11₂ sonlarining ayirmasini toping. 
+   001
...
174. Ikkilik sanoq sistemasidagi 10111₂ × 11₂ sonlarining ko'paytmasini toping. 
+   1000101₂	
...
+   kiritish/chiqarish interfays portlari
...
+   rejalashtirilgan uzilishlar kiritish/chiqarish qismi
...
+   to'g'ridan-to'g'ri xotiraga murojat
...
+   Ma'lumotlar turli xajmda bo'ladi
...
+   Ma'lumotlar turli xil formatda bo'ladi
...
+   K/Ch moduli CPUga ma'lumotni jo'natadi
...
213. Kompyuter ko'rsatmalar to'plami arxitekturasi bosqichlari to'g'ri ketma-ketlikda berilgan qatorni toping. 
...
218. Katta tezlikda ma'lumot saqlovchi protsessorda joylashgan xotira turi qanday nomlanadi? 

219. Kesh xotiradan ham tez hisoblangan xotira turi qanday nomlanadi?
+   registr
...
+   push G, push E, push F, mult, add

223. Berilgan ifodani accumulator arxitekturasida to'g'ri ketma-ketlikda ifodalang: G + E * F. 

224. Berilgan ifodani accumulator arxitekturasida to'g'ri ketma-ketlikda ifodalang: E/H – G. 

225. load A, mult B, add G, store F shaklida berilgan accumulator amalining vazifasi to'g'ri ko'rsatilgan qatorni toping. 
+   Load E, div H, sub G

226. Berilgan ifodani 3 operandali xotira-xotira arxitekturasida tasvirlang: A*B – (A+C*B).
+   mul D, A, B; mul E, C, B; add E, A, E; sub E, D, E

227. Berilgan ifodani 3 operandali xotira-xotira arxitekturasida tasvirlang: F*H.
+   mul G, F, H

228. Berilgan ifodani 3 operandali xotira-xotira arxitekturasida tasvirlang: E+F*H. 
+   mul G, F, H; add G, E, G

229. Berilgan ifodani 2 operandali xotira-xotira arxitekturasida tasvirlang: F*H.
+   mov G, F; mul G,H

230. Berilgan ifodani 2 operandali xotira-xotira arxitekturasida tasvirlang: F/H.
+   mov G, F; div G,H

231. Berilgan ifodani 2 operandali xotira-xotira arxitekturasida tasvirlang: G+F*H. 
+   Mov E, F; mul E, H; add E, G

232. Berilgan ifodani registr-xotira arxitekturasida tasvirlang: F*H.
+   load R1, F; mul R1, H

233. Berilgan ifodani registr-xotira arxitekturasida tasvirlang: G+F*H.
+   Load R1, F; mul R1, H; add R1, G

234. Load R1, &A ifodaga berilgan to'g'ri ta'rifni toping . 
+   1-registrga a ifodaning qiymatini o“zlashtirish

235. Berilgan ifodani Load-Store arxitekturasida tasvirlang: F*H. 
+   load R1, &F; load R2, &H, mul R3, R2, R1

236. Berilgan ifodani Load-Store arxitekturasida tasvirlang: G+F*H. 
+   load R1, &G; load R2, &F;load R3, &H; mul R4, R3, R2; add R5, R4, R1
...
+   xotiradan protsessorga ma'lumot yuklab olish
...
+   ma'lumotni microprotsessor ichida uzatish
...
+   Protsessorga tashqi muhitdan ma'lumot kirib kelishi
...
246. Quyidagi berilgan instruksiyalardan qaysi biri ADD,SUB, MUL, DIV singari operatsiyalarni bajarish uchun ishlatiladi? 

247. Quyidagi berilgan instruksiyalardan qaysi biri INC, DEC, AND, OR, XOR, NOT singari operatsiyalarni bajarish uchun ishlatiladi?
+   ma'lumotlar ustida amallar bejarish instruksiyalari

248. Quyidagi berilgan instruksiyalardan qaysi biri ma'lumotlarni bir joydan ikkinchi joyga ko'chirish uchun ishlatiladi? 
+   Ma'lumotlar ustida amallar bajarish
...
+   4-addressli qo'llanmada

255. Necha addressli qo'llanmada amal kodi, belgilangan joy, qiymat 1 va qiymat 2 mavjud bo'ladi? 

256. Necha addressli qo'llanmada amal kodi, belgilangan joy va qiymat 2 mavjud bo'ladi? 

257. Necha addressli qo'llanmada amal kod va qiymat 2 mavjud bo'ladi?
+   1-addressli qo'llanma

258. Necha addressli qo'llanmada faqat amal kodi mavjud bo'ladi?
-   1-addressli qo'llanma 

259. Manzillash rejimlarining necha turi mavjud? 

260. Quyidagilardan qaysi biri manzillash rejimlari turi hisoblanmaydi? 
+   qayta yozish rejimi

261. Quyidagilardan qaysi biri manzillash rejimlari turi hisoblanmaydi? 
...
266. Manzillari soni chegaralanganligi, instruksiyalar murakkablashib ketishi singari minus tomonlariga ega manzillash rejimi qanday nomlanadi?
-   bilvosita
-   manzilni o'zgartirish rejimi

267. Qaysi manzillash rejimida ko'rsatma xotirada joylashgan qiymatning manzilini beradigan registrni belgilaydi? 

268. Qaysi manzillash rejimida qiymatning kerakli manzili ko'rsatmaning o'zida mavjud bo'ladi? 

+ To'g'ridan to'gri manzillash rejimi
...
274. Qo'llanma addresslarida “belgilangan joy” necha bayt joy egallaydi? 

275. Qo'llanma addresslarida qiymatlar qancha joy egallaydi? 

276. Necha addressli qo'llanmada bitta qiymat natijani o'sha qiymat yozilgan manzilga qayta yozish imkonini beradi? 

277. Necha addressli qo'llanmada registr bitta amalni va natijani saqlab turadi? 

278. Berilgan ADD A, SUB A, MULT A kabi ifodalar necha addresli qo'llanmalarga misol bo'la oladi? 
-   3 addresli qo'llanmaga

279. Berilgan LOAD B, MUL C, STORE D kabi ifodalar necha addresli qo'llanmalarga misol bo'la oladi?
+   1 addressli qo'llanmaga

280. Necha addressli qo'llanmalar Stack ishlash prinsipiga asoslangan?
-   1 addressli qo'llanmaga

281. Berilgan PUSH A, PUSH B, MULT kabi ifodalar necha addresli qo'llanmalarga misol bo'la oladi? 
+   0 addressli qo'llanmaga
...
-    logik jarayonlarni amalga oshirishda ayirish uchun ishlatiladi
...
+   logic jarayonlarni amalga oshirishda ayirish uchun ishlatiladi
...
295. Protsessor va arifmetik logik unit holatini tekshiradigan registrlar qanday nomlanadi? 
...
299. Registrlarni boshqarish va backup(zahira) funksiyalarini yozish uchun ishlatiladigan registrlar nima deb nomlanadi? 
+   Umumiy maqsadda foydalaniladigan foydalanuvchi registrlari

300. Ma'lumotlarni boshqarish va backup(zahira) funksiyalarini yozish uchun ishlatiladigan registrlar qanday nomlanadi? 

301. Quyida berilganlardan qaysi biri umumiy maqsadda foydalaniladigan registrlarning vazifasi hisoblanmaydi? 

302. Eng ko'p ishlatilgan qiymatlarni o'zida saqlab turadigan registrlar qanday nomlanadi? 
+   ma'lumot registlari

303. Stack Pointer (address ko'rsatgichlar)ini o'zida saqlab turadigan registrlar qanday nomlanadi? 
+   Addres registrlari 

304. Dastur hisoblagichlarini saqlab turish uchun ishlatiladigan registrlar qanday nomlanadi? 
...
309. Quyidagilardan qaysi biri arifmetik operatsiyalarning natijasi emas? 
+   o'zgaruvchan natija

310. Quyidagi berilganlardan qaysi biri arifmetik operatsiyalarning natijasi emas? 
+   Takroriy natija

311. Protsessorda amalga oshiriladigan jarayonlarni nazorat qilish uchun ishlatiladigan registrlar qanday nomlanadi? 
+   nazorat va status registrlari

312. Ko'rsatma addressini o'zida saqlovchi registrlar nima deb nomlanadi? 

313. Foydalanuvchi tomonidan murojaat qilish, o'zgartirish imkoni bo'lmagan registrlar qanday nomlanadi? 

314. Oxirgi buyruqlarni o'zida saqlovchi registrlar qanday nomlanadi? 
+   Instruksiya registrlari

315. Xotira joylashuvini o'z ichiga oluvchi registrlar qanday nomlanadi? 
+   Xotira addresi registrlari

316. Xotiraga yoziladigan ma'lumotlarni o'zida saqlovchi registrlar qanday nomlanadi?
+   xotira buffer registrlari

317. Xotiradan o'qiladigan ma'lumotlarni o'zida saqlovchi registrlar qanday nomlanadi? 
+   xotira buffer registrlari

318. Kiritish/chiqarish qurilmalarining manzillarini o'zida saqlab turuvchi registrlar qanday nomlanadi?
+   I/O address registr
...
+   Sirkutlar sonini oshirish

321. Quyidagi berilganlardan qaysi biri CPUning tezligini oshirish uchun ishlatiladi? 
+   CPU qurilmalarini bir paytda bir nechta amallarni bajara oladigan qilib joylashtirsh
...
327. Quyida berilgan terminlardan qaysi biri qiymatlarni olish uchun ishlatiladi? 
-   Instruction Decode

328. Quyida berilgan terminlardan qaysi biri Instruksiyani amalga oshirish uchun ishlatiladi? 
+   Instruction ExecutionF

329. Quyida berilganlardan qaysi biri qiymat natijani saqlash uchun ishlatiladi? 
+   Operand store

330. Konveyerlash(Konveyerlash) protsessorlarining nechta turi bor? 
+   6ta

331. Butun va kasr qismli qiymatlar ustida matematik amallar bajarish uchun ishlatiladigan konveyerlash (konveyerlash) turi qanday nomlanadi? 
+   arifmetik konveyerlash

332. Bir qancha instruksiyalar parallel tarzda amalga oshirilishini ta'minlab beruvchi konveyerlash turi qanday nomlanadi? 

333. Bir ma'lumot ustida bir qancha amallarni bajarishda turli protsessorlardan foydalanish uchun qaysi konveyerlash turi ishlatiladi? 
+   protsessor konveyerlash

334. Agar bitta vazifa pipelineda qayta qayta bajarilsa bu qanday konveyerlash deb nomlanadi? 
+   Bir funksiyali konveyerlash

335. Agar bir qancha funksiyalar turli vaqtlarda amalga oshirilsa bu qanday konveyerlash deb nomlanadi? 
+   ko'p funksiyali konveyerlash
...
-   kiritish/chiqarish moduli sekinlashadi

343. Konveyerlashda nechta turdagi muammolar sodir bo'ladi? 

344. Konveyerlash muammolarining qaysi turida ikkita instruksiya bir xil qurilmani bir paytda ishlatishiga ehtiyoj tug'iladi? 
...
+   dastur ketma-keligini optimallashtirish

348. Quyida berilganlardan qaysi biri struktura yoki resurs muammosi yechimi hisoblanadi? 
...
+   RAW (Read After Write) ma'lumot muammolarida
...
+   WAR(Write After Read) ma'lumot muammolarida
...
+   ma'lumotlarni yozish,qayta yozish va murojat qilish magnit yordamida amalga oshiriladi
...
357. Magnit disk aylanayotganda bitta statsionar disk boshi ostidan o'tadigan diskdagi konsentrik aylana qanday nomlanadi? 
-   silindr
...
365. Optik disklardagi har bir sektor qanday hajmga ega?
+   2048 baytga

366. Bir qancha kompyuterlarning boshqa kompyuterlar bilan ma'lumotlar, dasturlar va resourselar raqamli tarzda almashishini ta'minlab beruvchi tizim qanday nomlanadi?
+   kompyuter tarmoqlari

367. Kompyuter tarmoqlarida bog'lanishlarning turi to'g'ri ko'rsatilgan qatorni toping. 
+   simli va simsiz

368. Quyida berilganlardan qaysi biri kompyuter tarmoqlarining asosi hisoblanadi? 
+   Nodelar va linklar
...
376. Quyida berilgan tarmoqlardan qaysi birida kompyuterlar o'zaro turli tarmoq kabellari orqali bog'langan bo'ladi va ma'lumot juda ham tez boshqa kompyuterlarga uzatiladi? 
...
382. Juda katta hududlarni, shtatlarni yoki mamlakatlarni oz'ida jamlaydigan tarmoq nima deb ataladi?
+   Wide Area Network
...
+   soat strilkasi yo'nalishi bo'yicha
...
+   Juda ko'p kabellar bo'lgani uchun harajat ko'p ketadi